...
class CreditRequest
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\User", inversedBy="creditRequestFor", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="InventoryBundle\Entity\ProductVariant", inversedBy="creditRequest")
