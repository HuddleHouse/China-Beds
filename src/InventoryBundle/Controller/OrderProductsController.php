...
class OrderProductsController extends Controller
{
    ...
    public function orderProductsAction()
    {
        ...
        $statement = $connection->prepare("select p.id, p.name, p.description, p.sku, ch.name as channel_name, ch.url as channel_url, ch.id as channel_id, cat.name as category_name, cat.id as category_id, ANY_VALUE(i.path) as path
	from product p
