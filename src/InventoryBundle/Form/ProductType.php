...
class ProductType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('hideFrontend', ChoiceType::class, array('attr' => array('style' => 'margin-bottom: 10px'), 'required' => false, 'label' => 'Hide product item from front end of site', 'choices' => ['0' => 'No', '1' => 'Yes']))
